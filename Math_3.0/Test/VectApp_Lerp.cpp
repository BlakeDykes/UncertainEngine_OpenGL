...
TEST(Vec3App_LERP_Array, TestConfig::ALL)
{
	...
	i = 0;
	CHECK(eq_float(vOut[i][x], vResult[i][x]));
	CHECK(eq_float(vOut[i][y], vResult[i][y]));
	CHECK(eq_float(vOut[i][z], vResult[i][z]));
...
TEST(Vec3App_LERP_Array0, TestConfig::ALL)
{
	...
	i = 0;
	CHECK(eq_float(vOut[i][x], vSourceA[i][x]));
	CHECK(eq_float(vOut[i][y], vSourceA[i][y]));
	CHECK(eq_float(vOut[i][z], vSourceA[i][z]));
...
TEST(Vec3App_LERP_Array1, TestConfig::ALL)
{
	...
	i = 0;
	CHECK(eq_float(vOut[i][x], vTargetB[i][x]));
	CHECK(eq_float(vOut[i][y], vTargetB[i][y]));
	CHECK(eq_float(vOut[i][z], vTargetB[i][z]));
