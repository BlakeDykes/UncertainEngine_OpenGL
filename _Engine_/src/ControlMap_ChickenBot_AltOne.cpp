#include "ControlMap_ChickenBot_AltOne.h"
#include "PlayerController.h"

namespace Uncertain
{

	void Uncertain::ControlMap_ChickenBot_AltOne::HandleAction(Keyboard::Key key, PlayerController& playerController)
	{
		Command* pCom;
		...
		case Keyboard::KEY_SLASH:
			break;
		case Keyboard::KEY_0:
			pCom = new CMD_SetAnim(*playerController.GetAnimController(), AnimName::S_CHICKENBOT_DIE_L, true);
			CommandQueueManager::SendData(pCom);
			break;
		...
		case Keyboard::KEY_8:
			break;
		case Keyboard::KEY_9:
			pCom = new CMD_SetAnim(*playerController.GetAnimController(), AnimName::S_CHICKENBOT_DIE_R, true);
			CommandQueueManager::SendData(pCom);
			break;
