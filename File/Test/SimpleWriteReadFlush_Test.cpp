...
TEST_WITH_TEARDOWN(SimpleWriteReadFlush, TestConfig::ALL)
{
#if SimpleWriteReadFlush
	...
	ferror = File::Open(fh, "file18.bin", File::Mode::READ_WRITE);
	fh_file23 = fh;
...
TEST_TEARDOWN(SimpleWriteReadFlush)
{
#if SimpleWriteReadFlush
